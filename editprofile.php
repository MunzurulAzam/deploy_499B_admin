                        ...
                        <form class="cmxform signupForm" method="post" enctype="multipart/form-data" >
                            <div id="firststep">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-animate-text notranslate" style="margin-top:40px !important;">
                                    ...
                                    <div class="form-group form-animate-text notranslate" style="margin-top:40px !important;" id="showselected">
									...
									{ 
									?>
                                    <div id="helthcare" class="form-group form-animate-text notranslate" style="margin-top:40px !important;">
