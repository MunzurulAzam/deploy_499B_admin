...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="icon icon-info"></i> Reject Appointment </h4>
</div>
<div class="modal-body" id="showuserinfo">
    <h4>Your Appointment Has Been Rejected !!!</h4>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" name="rejectappointment">Reject Appointment</button>
</div>
